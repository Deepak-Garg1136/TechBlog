		...
		<div class="row">
			...
			<div class="col-md-2 sidebar">
				...
				<div class="categories">
					<h5 class="cat" id="allPosts" onclick="getPosts(0, this, -1)"
						style="cursor: pointer;" id="0">All Posts</h5>
					<%
					for (Category c : list) {
					%>
					<h5 class="cat" id="<%=c.getCategoryId()%>"
						style="cursor: pointer;"
						onclick="getPosts(<%=c.getCategoryId()%>, this, -1)"><%=c.getcName()%></h5>
					<%
					}
					%>
				</div>
			...
			<aside class="col-md-3 right-sidebar py-4">
				...
				<div class="widget">
					...
					<div class="mainRPostDiv" style="height: 32vh">
						...
						<!-- 							<div class = "recentImg"> -->
						<!-- 							<img alt="" src="blogPic/java.png"> -->
						<!-- 							</div> -->
						<!-- 							<div class = "recentDetail"> -->
						<!-- 							<p class="posttitle">Discover Your Inner Genius To Better<br>MAR 29, 2024</p> -->
						<!-- 							</div> -->
						<!-- 						</div> -->
						<!-- 						<div class = "recentPosts"> -->
						<!-- 							<div class = "recentImg"> -->
...
function getPosts(catId, tempElement, all) {
    // Remove "styleCat" class from all category elements initially
...
function triggerH5Click(catId){
    ...
    getPosts(0, catElements[0], -1);
<%} else {%>
    getPosts("<%=session.getAttribute("postCategoryId")%>", document.getElementById("<%=session.getAttribute("postCategoryId")%>"), -1);
<%}%>
